...
exports.validatePostArray = [
  ...
  body("publishingDate")
    .isDate()
    .withMessage("book Publishing Date should be date"),
  body("category")
    .isString()
  ...
  body("avilable")
    .isInt()
    .withMessage(" avilable books number should be integer"),
  body("numOfCopies")
    .isInt()
    .withMessage("  number of book copies should be integer"),
...
exports.validatePatchArray = [
  ...
  body("edition")
    .optional()
    .isInt()
    .withMessage("book edition should be integer"),
